      ...
      <form
        ...
        onSubmit={(e) => {
          ...
          onAdd({
            ...
            data_type: "string",
            dataset_id: String(fd.get("dataset_id") ?? "") || undefined,
            column_name: String(fd.get("column_name") ?? "") || undefined,
          });
        ...
        {properties.map((prop) => (
          ...
          >
            ...
            <select
              ...
              onChange={(e) =>
                onUpdate(prop.id, { dataset_id: e.target.value, column_name: prop.column_name ?? "" })
              }
            >
              <option value="">Dataset</option>
              {datasets?.map((d) => (
